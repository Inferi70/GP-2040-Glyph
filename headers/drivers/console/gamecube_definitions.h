...
static constexpr gc_report_t default_gc_report = {
    .a = 0, .b = 0, .x = 0, .y = 0, .start = 0, .origin = 0, .reserved0 = 0,
    .dpad_left = 0, .dpad_right = 0, .dpad_down = 0, .dpad_up = 0, .z = 0, .r = 0, .l = 0, .reserved1 = 1,
    .stick_x = 128, .stick_y = 128, .cstick_x = 128, .cstick_y = 128, .l_analog = 0, .r_analog = 0,
};
